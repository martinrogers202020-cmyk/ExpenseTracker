...
object ReportPdfExporter {
    ...
    fun writeMonthlyReportPdf(
        ...
        fun footerText(): String {
            ...
            return context.getString(R.string.reports_generated_by, context.getString(R.string.app_name), ts)
        }
        ...
        fun finishPage(page: PdfDocument.Page) {
            ...
            canvas.drawText(
                context.getString(R.string.reports_page_label, pageNumber),
        ...
        canvas.drawText(context.getString(R.string.label_month), margin, y + 14f, paintH)
        ...
        // ----- Summary box -----
        canvas.drawText(context.getString(R.string.label_summary), margin, y + 14f, paintH)
        y += 22f
        ...
        summaryRow(context.getString(R.string.label_income), incomeText)
        summaryRow(context.getString(R.string.label_expenses), expenseText)
        summaryRow(context.getString(R.string.label_balance), balanceText)
        ...
        // ----- Categories table -----
        canvas.drawText(context.getString(R.string.reports_spending_by_category), margin, y + 14f, paintH)
        y += 20f
        ...
        fun tableHeader() {
            ...
            canvas.drawText(context.getString(R.string.label_category), margin, y + 18f, paintH)
            val amountHeader = context.getString(R.string.label_amount)
        ...
        if (categories.isEmpty()) {
            canvas.drawText(context.getString(R.string.reports_no_category_data), margin, y + 14f, paintMuted)
            y += 20f
        } else {
            categories.forEachIndexed { idx, (label, amountText) ->
                ...
                if (y == margin) {
                    ...
                    y += 26f
                    c.drawText(context.getString(R.string.reports_spending_by_category_continued), margin, y + 14f, paintH)
                    y += 18f
                    tableHeader()
                }
